                ...
                <div className="flex flex-col sm:flex-row gap-3 flex-wrap">
                    ...
                    <div className="relative min-w-[180px]">
                        ...
                        <select value={barangId} onChange={(e) => setBarangId(e.target.value)}
                            className="w-full appearance-none rounded-lg border border-slate-200 focus:border-rose-500 focus:ring-rose-500 pl-9 pr-4 py-2 text-sm transition-all bg-white text-slate-700">
