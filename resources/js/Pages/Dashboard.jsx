                                    ...
                                    <tr key={item.id} className="hover:bg-slate-50 transition-colors">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="bg-slate-100 rounded-lg overflow-hidden w-9 h-9 flex items-center justify-center border border-slate-200 shrink-0">
                                                    {item.foto ? (
                                                ...
                                                <div>
                                                    <p className="text-sm font-bold text-slate-900 leading-tight">{item.nama_barang}</p>
                                                    <p className="text-[10px] text-slate-400 font-mono mt-0.5">{item.kode_barang}</p>
                                                </div>
                                            </div>
                                        </td>
